...
<div class="col-lg-8">
  <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      @if ($post->image)
        <img src="{{ asset('my_files/' . $post->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
      @else
    ...
    <button type="button" class="btn btn-danger"><a href="/dashboard/posts" class="text-decoration-none text-white">Cancel</a></button>
  </form>
</div>
