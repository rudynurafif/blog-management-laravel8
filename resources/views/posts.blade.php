    ...
    <div class="card mb-3">
      @if ($posts[0]->image)
        <div style="max-height: 400px; overflow:hidden;">
          <img src="{{ asset('my_files/' . $posts[0]->image) }}" alt="{{ $posts[0]->category->name }}" class="img-fluid">
        </div>
      @else
        {{-- <img src="https://picsum.photos/id/{{ $posts[0]->category->id }}/1200/350" class="card-img-top" alt="{{ $posts[0]->category->name }}"> --}}
        <img src="https://picsum.photos/1200/400?random={{ $posts[0]->category->slug }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
      @endif
        ...
        @foreach ($posts->skip(1) as $post)
          <div class="col-md-4 mb-3">
            <div class="card">
              ...
              @else
                {{-- <img src="https://picsum.photos/id/{{ $post->category->id }}/500/300" class="card-img-top" alt="{{ $post->category->name }}"> --}}
                <img src="https://picsum.photos/500/300?random={{ $post->category->slug }}" class="card-img-top" alt="{{ $post->category->name }}">
              @endif
